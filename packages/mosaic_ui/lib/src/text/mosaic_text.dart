...
/// raw values.
enum MosaicTextTone { primary, secondary, accent, error, success, warning, inverse }
...
class MosaicText extends StatelessWidget {
  ...
  const MosaicText.display(this.text, {super.key, this.tone = MosaicTextTone.primary, this.color, this.textAlign, this.maxLines, this.overflow, this.softWrap, this.weight, this.height})
    : variant = MosaicTextVariant.display;
  const MosaicText.headline(this.text, {super.key, this.tone = MosaicTextTone.primary, this.color, this.textAlign, this.maxLines, this.overflow, this.softWrap, this.weight, this.height})
    : variant = MosaicTextVariant.headline;
  const MosaicText.title(this.text, {super.key, this.tone = MosaicTextTone.primary, this.color, this.textAlign, this.maxLines, this.overflow, this.softWrap, this.weight, this.height})
    : variant = MosaicTextVariant.title;
  const MosaicText.body(this.text, {super.key, this.tone = MosaicTextTone.primary, this.color, this.textAlign, this.maxLines, this.overflow, this.softWrap, this.weight, this.height})
    : variant = MosaicTextVariant.body;
  const MosaicText.caption(this.text, {super.key, this.tone = MosaicTextTone.secondary, this.color, this.textAlign, this.maxLines, this.overflow, this.softWrap, this.weight, this.height})
    : variant = MosaicTextVariant.caption;
  const MosaicText.metric(this.text, {super.key, this.tone = MosaicTextTone.primary, this.color, this.textAlign, this.maxLines, this.overflow, this.softWrap, this.weight, this.height})
    : variant = MosaicTextVariant.metric;
  const MosaicText.tileTitle(this.text, {super.key, this.tone = MosaicTextTone.primary, this.color, this.textAlign, this.maxLines, this.overflow, this.softWrap, this.weight, this.height})
    : variant = MosaicTextVariant.tileTitle;
  const MosaicText.tileSubtitle(this.text, {super.key, this.tone = MosaicTextTone.secondary, this.color, this.textAlign, this.maxLines, this.overflow, this.softWrap, this.weight, this.height})
  ...
  static TextStyle _styleFor(MosaicTokens tokens, MosaicTextVariant v) => switch (v) {
  ...
  static Color _toneColor(MosaicTokens tokens, MosaicTextTone tone) => switch (tone) {

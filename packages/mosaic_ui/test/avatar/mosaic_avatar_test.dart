...
void main() {
  ...
  testWidgets('renders one-letter initials from a single name', (tester) async {
  ...
  testWidgets('child wins over name when both are provided', (tester) async {
    await tester.pumpWidget(
      _wrap(const MosaicAvatar(name: 'John Simiyu', child: Text('X'))),
    );
  ...
  testWidgets('size token maps to a fixed pixel size', (tester) async {
    await tester.pumpWidget(
      _wrap(const MosaicAvatar(name: 'A', size: MosaicAvatarSize.lg)),
    );
  ...
  testWidgets('background override beats token', (tester) async {
    ...
    await tester.pumpWidget(
      _wrap(const MosaicAvatar(name: 'A', background: override)),
    );
    final container = tester.widget<Container>(find.byType(Container));
